...
class ClassificationModel(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        loss_q12 = self.criterion(logits["q12_logit"], target_neg)


        loss = (loss_a1 + loss_a2 + loss_a3 + loss_q12) / 4
