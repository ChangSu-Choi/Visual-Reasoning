        ...
        if root == train_dir:  # only process first level directories
            for directory_parent in dirs:
                ...
                for directory in train_dir_list:
                    ...
                    a_data["question_img1"] = a_data["Questions"][0]
                    a_data["question_img2"] = a_data["Questions"][1]

                    if a_data["correct_question_group_ID"] != a_data["question_img1"]["group_id"]:
                        a_data["question_img1"], a_data["question_img2"] = a_data["question_img2"], a_data["question_img1"]
