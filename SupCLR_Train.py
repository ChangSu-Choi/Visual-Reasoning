...
from utills.SupCLR import SupCLR_Loss
from utills.SupCLR import SupCLR
import numpy as np
import timm
import argparse
import yaml
...
def main(args):
    ...
    checkpoint_callback = ModelCheckpoint(
        ...
        dirpath='checkpoint/SupCLR',  # 체크포인트 저장 경로
    )
    
    # 텐서 보드 
    logger = TensorBoardLogger("tb_logs/SupCLR", name=f"SupCLR-{args.model_name}-bs{args.batch_size}-epochs{args.epochs}")
